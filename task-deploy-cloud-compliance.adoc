...
Wenn Sie noch keinen Konnektor haben, erstellen Sie jetzt einen Konnektor. Siehe https://["Erstellen eines Konnektors in AWS"^], https://["Erstellen eines Connectors in Azure"^], Oder https://["Erstellen eines Konnektors in GCP"^].

[role="quick-margin-para"]
Das können Sie auch https://["Installieren Sie den Steckverbinder vor Ort"^] Auf einem Linux-Host in Ihrem Netzwerk oder auf einem Linux-Host in der Cloud.
...
Falls Sie noch keinen Connector haben, erstellen Sie bei Ihrem Cloud-Provider einen Connector. Siehe https://["Erstellen eines Konnektors in AWS"^] Oder https://["Erstellen eines Connectors in Azure"^], Oder https://["Erstellen eines Konnektors in GCP"^]. In den meisten Fällen ist wahrscheinlich vor der Aktivierung der BlueXP Klassifizierung ein Connector eingerichtet https://["Für BlueXP-Funktionen ist ein Connector erforderlich"], Aber es gibt Fälle, in denen Sie müssen, um eine Einrichtung jetzt.
...
Beachten Sie, dass Sie auch können https://["Installieren Sie den Steckverbinder vor Ort"^] Auf einem Linux-Host in Ihrem Netzwerk oder in der Cloud. Einige Benutzer, die die BlueXP Klassifizierung lokal installieren möchten, können den Connector möglicherweise auch On-Premises installieren.
...
https://["Weitere Informationen zur Bereitstellung des Connectors in einer Regierungsregion finden Sie unter"^].
...
Für die Implementierung von Azure und Azure Government sind zusätzliche Regeln für ein- und ausgehende Sicherheitsgruppen erforderlich. Siehe https://["Regeln für den Connector in Azure"^] Entsprechende Details.
...
* https://["AWS Dokumentation: Amazon EC2 Service Quotas"^]
* https://["Azure Dokumentation: VCPU Kontingente von Virtual Machines"^]
* https://["Google Cloud Dokumentation: Ressourcenkontingente"^]
