...
[role="quick-margin-para"]
Hierfür ist ein BlueXP Abonnement über Ihren Cloud-Provider Marketplace erforderlich.
...
On-Premises-ONTAP-Systeme, NetApp-Dateifreigaben, generischer S3-Objektspeicher und Datenbanken können über eine dieser Cloud-Connectors gescannt werden.
