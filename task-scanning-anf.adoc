...
Vor dem Scannen von Azure NetApp Files-Volumes https://["BlueXP muss eingerichtet sein, um die Konfiguration zu ermitteln"^].
...
https://["Erfahren Sie, wie Sie das Azure NetApp Files-System in BlueXP entdecken"^].
