...
+
Data Sense kann keine Berechtigungen oder letzten Zugriffszeiten aus 7-Mode Systemen extrahieren. Darüber hinaus gibt es ein bekanntes Problem, bei dem das Mounten von CIFS-Freigaben auf SMB Version 2 für Linux nicht unterstützt wird.
