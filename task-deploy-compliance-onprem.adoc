...
summary: Führen Sie einige Schritte durch, um Cloud Data Sense auf einem Linux-Host in Ihrem Netzwerk oder auf einem Linux-Host in der Cloud mit Internetzugang zu implementieren. 
---
= Implementieren Sie Cloud Data Sense auf einem Host mit Internetzugang
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Führen Sie einige Schritte durch, um Cloud Data Sense auf einem Linux-Host in Ihrem Netzwerk oder auf einem Linux-Host in der Cloud mit Internetzugang zu implementieren.
...
. Je nachdem, ob Sie eine Instanz in der Cloud oder eine Instanz in Ihrem Haus bereitstellen, klicken Sie auf die entsprechende Schaltfläche *Bereitstellen*, um den Data Sense Deployment Wizard zu starten.
+
