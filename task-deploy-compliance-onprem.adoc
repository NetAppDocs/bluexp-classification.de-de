...
** Rocky Linux 9 (erfordert BlueXP Klassifizierung von Version 1.24 und höher)
...
https://youtu.be/gE-vrBLSJqw["Hier geht's zum Video"] Informationen zur Installation der BlueXP Klassifizierung.
...
[source, cli]
----
tar -xzf DATASENSE-INSTALLER-V1.22.0.tar.gz
----
...
+
Beachten Sie, dass das Installationsprogramm eine Vorprüfung durchführt, um sicherzustellen, dass Ihre System- und Netzwerkanforderungen für eine erfolgreiche Installation erfüllt werden. https://youtu.be/UZtn_I0e1Ls["Hier geht's zum Video"] Um die Pre-Check-Meldungen und -Auswirkungen zu verstehen.
