...
| Connector <> BlueXP Klassifizierung | 8080 (TCP), 6000 (TCP), 443 (TCP) UND 80 | Die Sicherheitsgruppe für den Connector muss ein- und ausgehenden Datenverkehr über die Ports 6000 und 443 zur und von der BlueXP Klassifizierungsinstanz zulassen.
...
* Überprüfen Sie, ob Sie die beiden erforderlichen Softwarepakete (Docker Engine und Python 3) installiert haben.
