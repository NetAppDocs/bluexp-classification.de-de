...
summary: Führen Sie einige Schritte durch, um Cloud Data Sense auf einem Host an einem lokalen Standort ohne Internetzugang zu implementieren. Diese Art der Installation ist perfekt für Ihre sicheren Standorte. 
---
...
[role="lead"]
Führen Sie einige Schritte durch, um Cloud Data Sense auf einem Host an einem lokalen Standort ohne Internetzugang zu implementieren. Diese Art der Installation ist perfekt für Ihre sicheren Standorte.
...
| Groß | 16 CPUs | 64 GB RAM | 500-GB-SSD auf / oder * 100 GB verfügbar auf /opt * 395 GB verfügbar auf /var * 5 GB auf /tmp 


| Mittel | 8 CPUs | 32 GB RAM | 200-GB-SSD auf / oder * 50 GB verfügbar auf /opt * 145 GB verfügbar auf /var * 5 GB auf /tmp 


| Klein | 8 CPUs | 16 GB RAM | 100-GB-SSD auf / oder * 50 GB verfügbar auf /opt * 45 GB verfügbar auf /var * 5 GB auf /tmp 
|===
+
...
.Bevor Sie beginnen
* Die Software Data Sense kann jeweils eine Hauptversion aktualisiert werden. Wenn beispielsweise Version 1.18.x installiert ist, können Sie nur auf 1.19.x aktualisieren Wenn Sie einige Hauptversionen hinter sich haben, müssen Sie die Software mehrmals aktualisieren.
