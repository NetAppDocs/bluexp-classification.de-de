...
---
= Implementieren Sie Cloud Data Sense auf einem Host ohne Internetzugang
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Das Dialogfeld _Deploy Data Sense on premise_ wird angezeigt. Kopieren Sie den angegebenen Befehl und fügen Sie ihn in eine Textdatei ein, damit Sie ihn später verwenden können, und klicken Sie auf *Schließen*. Beispiel:
+
