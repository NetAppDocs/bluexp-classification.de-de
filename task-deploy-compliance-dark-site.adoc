...
* Vergewissern Sie sich, dass Ihre BlueXP Connector-Software auf die neueste verfügbare Version aktualisiert wurde. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#upgrade-the-connector-when-using-private-mode["Siehe die Schritte zur Aktualisierung des Connectors"^].
