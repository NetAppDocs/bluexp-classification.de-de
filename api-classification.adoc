...
summary: Die über die Web-Benutzeroberfläche verfügbaren BlueXP classification sind auch über die REST-API verfügbar. 
---
...
[role="lead"]
Die über die Web-Benutzeroberfläche verfügbaren BlueXP classification sind auch über die REST-API verfügbar.
...
Um auf die API-Referenz zuzugreifen, benötigen Sie die IP-Adresse Ihrer BlueXP classification .  Wenn Sie über eine Cloud-Bereitstellung verfügen, verwenden Sie die öffentliche ID-Adresse. Beispiel:
