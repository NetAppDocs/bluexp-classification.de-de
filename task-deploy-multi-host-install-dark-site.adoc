...
Das können Sie auch link:task-licensing-datasense.html["Byol-Lizenzierung für die BlueXP Klassifizierung einrichten"] Von der BlueXP Digital-Wallet-Seite aus. Sie werden auch nach Ablauf der 30-tägigen kostenlosen Testversion nicht belastet.
