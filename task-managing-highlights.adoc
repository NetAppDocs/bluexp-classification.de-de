...
Sie können Dateien manuell aus dem Untersuchungsbereich löschen, oder link:task-using-policies.html#delete-source-files-automatically-using-policies["Automatische Verwendung von Richtlinien"^].
