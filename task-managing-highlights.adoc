...
.Anforderungen
* Sie müssen über die Berechtigung zum Kopieren von Dateien verfügen. link:concept-cloud-compliance.html["Erfahren Sie mehr über den Benutzerzugriff auf Compliance-Informationen"] .
...
.Anforderungen
* Sie müssen über die Berechtigung zum Kopieren und Synchronisieren von Dateien verfügen. link:concept-cloud-compliance.html["Erfahren Sie mehr über den Benutzerzugriff auf Compliance-Informationen"] .
* Sie müssen mindestens 20 Dateien auswählen.
...
.Anforderungen
* Sie müssen über die Berechtigung zum Verschieben von Dateien verfügen. link:concept-cloud-compliance.html["Erfahren Sie mehr über den Benutzerzugriff auf Compliance-Informationen"] .
...
.Anforderungen
* Sie müssen über die Berechtigung zum Löschen von Dateien verfügen. link:concept-cloud-compliance.html["Erfahren Sie mehr über den Benutzerzugriff auf Compliance-Informationen"] .
