...
https://["Sehen Sie sich die Anwendungsfälle für die BlueXP Klassifizierung an"^].
...
* Anzeigen und ändern Sie https://["Azure Information Protection (AIP)-Etiketten"^] In Ihren Dateien.
...
* Sparen Sie Storage-Kosten, indem Sie inaktive Daten ermitteln, die auf kostengünstigeren Objektspeicher verschoben werden können. https://["Weitere Informationen zum Tiering von Cloud Volumes ONTAP Systemen"^]. https://["Weitere Informationen zum Tiering von lokalen ONTAP Systemen"^].
...
* https://["AWS: Amazon EC2-Preisgestaltung"^]
* https://["Microsoft Azure: Preisangaben Für Die Bandbreite"^]
* https://["Google Cloud: Preis für Storage Transfer Service"^]
...
Wenn Sie die BlueXP Klassifizierung in der Cloud implementieren, stellt BlueXP die Instanz im selben Subnetz bereit, in dem sich der Connector befindet. https://["Erfahren Sie mehr über Steckverbinder."^]
...
* In AWS wird die BlueXP Klassifizierung auf einer ausgeführt https://["M6i.4xlarge-Instanz"^] Mit einer GP2-Festplatte mit 500 gib. Das Betriebssystem-Image ist Amazon Linux 2. Bei der Implementierung in AWS können Sie eine kleinere Instanzgröße wählen, wenn Sie eine kleine Datenmenge scannen.
...
https://["Erfahren Sie mehr über BlueXP-Rollen"^] Und wie https://["Benutzer mit bestimmten Rollen hinzufügen"^].
