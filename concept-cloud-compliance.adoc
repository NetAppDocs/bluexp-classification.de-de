...
* File Shares (z. B. Dell EMC Isilon, Pure Storage, Nutanix usw.)
* Datenbanken:
+
...
Die BlueXP Klassifizierung ist jetzt für bis zu 500 tib Daten kostenlos. Es ist keine Klassifizierungslizenz oder kostenpflichtiges Abonnement erforderlich. Bei mehr als 500 tib Daten können Sie die Suche auf einigen Ihrer Originalsysteme deaktivieren und die neuen Systeme scannen, bei denen Sie andernfalls das 500-tib-Limit überschreiten würden.
