...
Der Datensense kann zwischen 15-40 TIBS Daten pro Tag und pro Scannerknoten scannen. Die Scan-Geschwindigkeit wird durch Netzwerklatenz, Festplattenlatenz, Netzwerkbandbreite, Umgebungsgröße und Dateiverteilungsgrößen beeinflusst.
