...
Sie können den Firmennamen, der auf der ersten Seite des Berichts angezeigt wird, oben auf der Seite „Data Sense“ anpassen, indem Sie auf klicken image:screenshot_gallery_options.gif["Schaltfläche „Mehr“"] Und dann auf *Firmenname ändern* klicken.
